...
/**
 * @ngdoc function
 * @name tpanalyticsApp.controller:CatOverviewCategoryController
 * @description
 * # CatOverviewCategoryController
 * Controller of the tpanalyticsApp
 */
angular.module('tpanalyticsApp')
   .controller('CatOverviewCategoryController',['$scope','$rootScope', '$timeout', '$http','queryService', function ($scope,$rootScope, $timeout, $http,queryService) {
